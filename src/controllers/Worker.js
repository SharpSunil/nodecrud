...
//       "SELECT * FROM worker WHERE worker_card_number = ? OR worker_pan_number =? OR worker_uid_number =?", // for this query Do not create duplicate entry
...
//     } else {
//       res.status(200).json({
//         message: "Data is unique. Proceed with your operation.",
//       });
//     }
...
// export default  {createworker, viewworker};
